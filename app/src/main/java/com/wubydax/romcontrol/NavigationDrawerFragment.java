...
public class NavigationDrawerFragment extends Fragment implements NavigationDrawerCallbacks {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter.setProEnabled(isProEnabled());
    ...
    private  boolean isProEnabled(){
     boolean isInstalled;
        ...
        try {
            ...
            PackageInfo pInfo2 = packageManager.getPackageInfo(getActivity().getPackageName(), PackageManager.GET_SIGNATURES);
    ...
    public void setProEnabled2() {
        mIsPro = isProEnabled();
        TextView prottitle = (TextView) view.findViewById(R.id.protitle);
        if (mIsPro) {
            prottitle.setVisibility(View.VISIBLE);
        } else {
            prottitle.setVisibility(View.GONE);
        }
    }
