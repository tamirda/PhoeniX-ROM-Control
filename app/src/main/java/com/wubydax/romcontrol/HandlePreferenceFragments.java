    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        switch (p.getClass().getSimpleName()) {
            case "SwitchPreference":
                ...
                if (key.equals("enable_data_view")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("carrier_info_notif")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("enable_blur_notif")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("enable_custom_bg")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("link_toggle_icon_colors")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("link_lockscreen_colors")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("psm_notif_color")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("psm_notif")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("battery_full_notif")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("battery_notif")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("lockscreen_rotate")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("scaling_toggle")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("battery_full_notif")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("launcher_rotation")) {
                    appRebootRequired("com.sec.android.app.launcher");
                } else if (key.equals("launcher_scroll")) {
                    appRebootRequired("com.sec.android.app.launcher");
                } else if (key.equals("enable_icon_colors")) {
                    appRebootRequired("com.sec.android.app.launcher");
                } else if (key.equals("email_security")) {
                    appRebootRequired("com.samsung.android.email.provider");
                } else if (key.equals("auto_call_record_in")) {
                    appRebootRequired("com.android.incallui");
                } else if (key.equals("auto_call_record_out")) {
                    appRebootRequired("com.android.incallui");
                } else if (key.equals("enable_clock_text_color")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("enable_battery_text_color")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("link_icon_colors")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("link_expanded_colors")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("link_header_clock_colors")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("link_clear_noti_colors")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("link_toggle_icon_colors")) {
                    appRebootRequired("com.android.systemui");
                }
            ...
            case "CheckBoxPreference":
                ...
                if (key.equals("custom_lock_carrier")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("lockscreen_quick_unlock_control")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("lockscreen_scramble_pin_layout")) {
                    appRebootRequired("com.android.systemui");
                }
                break;
            case "MyListPreference":
                ...
                if (key.equals("toggle_type_key")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("tw_page_effect")) {
                    appRebootRequired("com.sec.android.app.launcher");
                } else if (key.equals("settings_layout_num")) {
                    appRebootRequired("com.android.settings");
                } else if (key.equals("settings_fav_columns")) {
                    appRebootRequired("com.android.settings");
                } else if (key.equals("db_call_delay")) {
                    appRebootRequired("com.android.incallui");
                } else if (key.equals("lockscreen_notifications")) {
                    appRebootRequired("com.android.systemui");
                }
                break;
            ...
            case "ColorPickerPreference":
                ...
                if (key.equals("toggle_text_color")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("toggle_sec_text_color")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("toggle_buttons_background_color")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("toggle_icon_on_color")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("toggle_icon_off_color")) {
                    appRebootRequired("com.android.systemui");
                }
                break;
            case "ThumbnailListPreference":
                ThumbnailListPreference b = (ThumbnailListPreference) pf.findPreference(key);
                String bValue = sharedPreferences.getString(key, "");
                if (bValue != null) {
                    b.setSummary(sharedPreferences.getString(key, ""));
                }
                if (key.equals("toggle_background")) {
                    appRebootRequired("com.android.systemui");
                }
                break;
            case "FilePreference":
                ...
                if (key.equals("modcfg_avcr_button")) {
                    appRebootRequired("com.android.incallui");
                }
                break;
        }
