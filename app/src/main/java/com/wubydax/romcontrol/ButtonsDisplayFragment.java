...
public class ButtonsDisplayFragment extends PreferenceFragment {
    HandlePreferenceFragments hpf;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        hpf = new HandlePreferenceFragments(getActivity(), this, "buttons_display_prefs");
    ...
    public void disablePreferences(){
        getPreferenceManager().findPreference("all_rotations").setEnabled(false);
    }
